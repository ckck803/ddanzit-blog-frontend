<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <!-- <div class="flex w-full h-[calc(100vh-5rem)] px-4 py-8"> -->
    <div class="flex h-[calc(100vh-4rem)] px-4 py-8">
      <div class="flex-1 flex flex-col w-full overflow-y-auto md:mr-3">
        <div class="">
      ...
      <!-- Preview -->
      <div class="flex-1 flex flex-col w-full md:pl-3">
        <div
          class="bg-white dark:bg-gray-800 rounded-lg p-6 flex flex-col h-full"
        >
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">
            미리보기
          </h2>
